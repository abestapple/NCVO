...
class ModernNcView(ctk.CTk):
    ...
    def create_sidebar(self):
        ...
        self.font_dropdown = ctk.CTkComboBox(font_frame, values=['DejaVu Sans', 'Arial', 'Times New Roman', 'Helvetica', 'Courier New', 'Consolas'], width=130)
        self.font_dropdown.set('DejaVu Sans')
        ...
        # ==========================================
        # 6. Export & Save (数据与图像导出区)
        # ==========================================
        sec6 = ctk.CTkFrame(self.sidebar, corner_radius=8)
        sec6.pack(fill="x", padx=10, pady=(0, 20))
        ctk.CTkLabel(sec6, text="6. Export & Save", font=ctk.CTkFont(weight="bold")).pack(anchor="w", padx=10, pady=(10, 5))
    ...
    def export_image(self):
        ...
        try:
            ...
            # 强制 facecolor='white'，确保放入PPT时不会透明遮挡
